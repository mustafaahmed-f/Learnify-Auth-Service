...
export type OutboxEventMinAggregateOutputType = {
  id: string | null
  type: $Enums.OutboxEventType | null
...
export type OutboxEventWhereInput = {
  ...
  type?: Prisma.EnumOutboxEventTypeFilter<"OutboxEvent"> | $Enums.OutboxEventType
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  type?: Prisma.EnumOutboxEventTypeWithAggregatesFilter<"OutboxEvent"> | $Enums.OutboxEventType
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "type" | "aggregateId" | "payload" | "status" | "attempts" | "nextAttemptAt" | "createdAt" | "processedAt" | "lastError", ExtArgs["result"]["outboxEvent"]>
...
export interface OutboxEventFieldRefs {
  ...
  readonly type: Prisma.FieldRef<"OutboxEvent", 'OutboxEventType'>
